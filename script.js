...
function updateView(direction = 0) {
    ...
    if (heroSubHeading) {
        heroSubHeading.style.color = currentPizza.activeTextColor; // Contrast color for sub heading
    }
    ...
    if (heroHeading) {
        ...
        setTimeout(() => {
            ...
            heroHeading.style.color = currentPizza.activeTextColor; // Contrast color for main heading
